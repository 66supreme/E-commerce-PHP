            ...
            <div class="p-5">
              ...
              <table class="table" height="190">
                ...
                <tbody>
                  <tr class="mb-4">
                    <th scope="row">1</th>
                    <td><img width="100" height="100" src="../images/django.png" class="img-fluid rounded-3" alt="Cotton T-shirt">
                    </td>
                    <td>Django Book</td>
                    <td>$20</td>
                    <td><input id="form1" min="1" name="quantity" value="1" type="number" class="form-control form-control-sm" /></td>
                    <td>$120</td>
                    <td><a href="#" class="btn btn-danger text-white"><i class="fas fa-trash-alt"></i> </a></td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
                    <td><img width="100" height="100" src="../images/node.png" class="img-fluid rounded-3" alt="Cotton T-shirt">
                    </td>
                    <td>Node Book</td>
                    <td>$20</td>
                    <td><input id="form1" min="1" name="quantity" value="1" type="number" class="form-control form-control-sm" /></td>
                  ...
                  <tr>
                    <th scope="row">3</th>
                    <td><img width="100" height="100" src="../images/html5.jpg" class="img-fluid rounded-3" alt="Cotton T-shirt">
                    </td>
                    <td>HTML5 Book</td>
                    <td>$20</td>
                    <td><input id="form1" min="1" name="quantity" value="1" type="number" class="form-control form-control-sm" /></td>
